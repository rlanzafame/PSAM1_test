...
# ---
# 
# ## 3. Structural deficient bridges
# 
# <center><img title="a title" alt="Culvert figure" src="https://raw.githubusercontent.com/mike-mendoza/-PSAM1_test/main/images/Old_bridge.jpg" width="300" 
#      height="200" /></center>
# 
# According to a [2021 report](https://infrastructurereportcard.org/cat-item/bridges-infrastructure/), 7.5% of the United States bridges are considered structurally deficient. A random sample of 20 bridges is taken.
# 
# Please answer the following (round the answer to four decimal places):
